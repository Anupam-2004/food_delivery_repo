    ...
    <Container>
      ...
      <Row>
        <Col className="about" md={8}>
          <h2>About</h2>
          <p>
            Feel the unique experiance at Zing Restaurant "The Golden Iris"
            Golmuri. Celebrate you ge together with your old friends with unique
            experiance
          </p>
      ...
      <Row className="feedback">
        <Col md={8}>
          <div className="tips">
            ...
            <p>No tips for this property yet. To add a tip, write a review.</p>
      ...
      <Row>
        ...
        <Col md={6} className="d-flex align-items-center">
          <a href="https://maps.google.com" className="text-decoration-none">
            Golmuri Main Road Near R.D. Tata Technical Institute, Jamshedpur
            831009, India
          </a>
        </Col>
