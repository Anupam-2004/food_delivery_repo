  ...
  if (loading) {
    return (
      <Container className="text-center py-5">
        ...
        <p className="mt-3">Loading all orders...</p>{" "}
      </Container>
    );
  }
  if (restaurentOrders.length === 0) {
    return (
      <Container className="text-center py-5">
        ...
        <p className="text-muted"> There are no orders available. </p>{" "}
      </Container>
    );
  }
  return (
    <Container className="mt-4 mb-5">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
          {" "}
          <h2 className="fw-bold mb-1">All Orders</h2>{" "}
            ...
            <Card.Body>
              ...
              <div className="d-flex justify-content-between align-items-start">
                ...
                <div>
                  ...
                  <h5 className="fw-bold mb-1"> #{orderId || "N/A"} </h5>{" "}
                  {order.createdAt && (
              ...
              <Row className="mb-4">
                ...
                <Col md={4}>
                  ...
                  <h5 className="fw-bold text-primary">
                    {" "}
                    ₹{" "}
                    {Number(order.totalAmount || order.price || 0).toFixed(
                      2,
                    )}{" "}
                  </h5>{" "}
                </Col>{" "}
